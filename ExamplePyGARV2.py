...
function. The difference from the ExamplePyGARV is that the number
of generations is controlled by a while loop. (look at the end of the file)
...
i = 0
while i < 1000 or garv.foundSolution == False:
	garv.runGA(1) #runs the Genetic Algorithm for 1 generation
	i = i + 1
